...
function getUsers() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const userResponse = yield client.query(selectUsersText);
        console.log("Users:");
...
function getUserFromEmail(email) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const userResponse = yield client.query(SelectUserText, [email]);
...
function getUserTodos(userId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const todosResponse = yield client.query(selectTodosText, [userId]);
